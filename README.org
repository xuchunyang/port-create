...
The following ideas are under consideration. I need to to confirm the necessity
and possibility.

** Intergrate with cpan2port and pypi2port
I still don't how to use these two tools. I'll investigate them.

** Write more tools to generate Portfile for other package manager
